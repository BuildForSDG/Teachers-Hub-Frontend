...
const Main = (props) => (
  <div>
    ...
    <CourseCardContainer courseData={props.courseData} />
      ...
      <div className="container">
        <div className="row mb-3 justify-content-center">
          <div className="col-lg-7 text-center" data-aos="fade-up" data-aos-delay="">
            ...
            <p>
              Publish your passions your way. Whether you would like to share your knowledge, experiences or the latest
              news in Education, create a unique and beautiful blog for free.
            </p>
          </div>
        </div>
        <BlogCardContainer />
      ...
      <div className="container">
        <div className="row mb-5 justify-content-center">
          <div className="col-lg-7 mb-5 text-center" data-aos="fade-up" data-aos-delay="">
            ...
            <p className="mb-5">
              Our partners help to provide learning material and mentorship to more than five thousand teachers each
              year. Learn more about our partners work and how to take part in their courses.
            </p>
          </div>
        </div>
        <div className="row">
          <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div className="teacher text-center">
              ...
              <div className="py-2">
                ...
                <p>
                  Cabe Academic Partners provides access to a variety of CABE resources including access to online
                  communities that facilitate networking with experienced professionals.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div className="teacher text-center">
              ...
              <div className="py-2">
                ...
                <p>
                  edx provides access to 2000 free online courses from 140 leading institutions worldwide. Helps you
                  gain new skills and earn a certificate of completion.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div className="teacher text-center">
              ...
              <div className="py-2">
                ...
                <p>
                  Join millions of people learning on FutureLearn. Find online courses and degrees from leading
                  universities or organisations and start learning online today.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="container">
        <div className="row justify-content-center align-items-center">
          <div className="col-md-8 text-center testimony">
            ...
            <blockquote>
              <p>
                &ldquo; Meet other Teachers Hub online teachers and mentors. Having caring, dedicated, and talented
                virtual educators and mentors is important to a teachers academic success. &rdquo;
              </p>
            </blockquote>
            <p data-aos="fade-up" data-aos-delay="300">
              <a href="/community" className="btn btn-primary py-3 px-5 btn-pill">
                Visit Community
              </a>
            </p>
          </div>
