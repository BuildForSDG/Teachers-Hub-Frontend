...
export const CourseCard = (props) => {
  ...
  return (
        ...
        <div key={course.course_id} onClick={handleClick}>
 ...
 <Link to={`/courses/${course.course_id}`}>
                            ...
                            <div className='col-sm-7 '>
                                <div className='card-body '>
                                    ...
                                    <p className='card-text'>Description: {course.course_description}</p>
                                    <span className='course-price'>{course.course_name}</span>
