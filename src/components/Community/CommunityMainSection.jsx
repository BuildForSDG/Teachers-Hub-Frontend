          ...
          <div className="col-12">
            <div className="row justify-content-center align-items-center text-center">
              <div className="col-lg-6" >
                <div className = 'row'>
                    <input className = 'form-control  col-md-9 offset-md-1 ' id = 'searchTerm' placeholder='Type your Query...' />
                    <button type = 'button' className='btn btn-primary' id = 'searchButton'><i className="fa fa-search" aria-hidden="true"></i> </button>
                </div>
              </div>
            </div>
          </div>
